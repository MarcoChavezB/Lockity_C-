...
for (int i = 0; i < usuarioCount; i++) {
  if (usuarios[i].role == "user") {
    ...
    /* u8g2.drawXBM(2, 23, 18, 18, drawer_draw);
    u8g2.drawXBM(2, 2, 18, 18, drawer_draw);
    u8g2.drawXBM(2, 44, 18, 18, drawer_draw);


    u8g2.drawStr(24, 16, "Alonso");
    u8g2.drawStr(24, 37, "Marco");
    u8g2.drawStr(24, 58, "Viki");

    u8g2.drawXBM(5, 4, 13, 13, circle_draw);
    u8g2.drawXBM(5, 25, 13, 13, circle_draw);
    u8g2.drawXBM(5, 46, 13, 13, circle_draw); */
